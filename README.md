...
3. Run Migrations
   ...
   ```
    ...
    If you do not see the following in the terminal, that means migrations did not work. Delete the 'development.sqlite' file in the 'db' folder and try ```rake db:migrate``` again.
